...
class UserInterface(ABC):
    @abstractmethod
    def get_contact_info(self, contacts):
        pass

    @abstractmethod
    def contact_name_request(self, notes):
        pass
...
class CommandProcessorApp(UserInterface):
    def __init__(self, app, address_book, notes_book):  # Добавила список заметок как аргумент в класс
        self.app = app
    ...
    def get_contact_info(self, info_type):
        contact_info = simpledialog.askstring(
            "Додавання контакту", f"Введіть {info_type} (якщо ні - закрийте вікно):"
        )
        return contact_info if contact_info else None
    ...
    def contact_name_request(self, name):
        contact = simpledialog.askstring("Введіть ім'я контакту:", f"Введіть {name}")
        return contact if contact else None
    ...
    def find_contact(self):  # Поиск контакта
        contact_name = self.contact_name_request("Ім'я")
        try:
    ...
    def add_contact(self):
        ...
        contact_mail = self.get_contact_info("пошту контакту")
        ...
        contact_address = self.get_contact_info("адресу контакту")
        contact_birthday = self.get_contact_info("день народження контакту")
